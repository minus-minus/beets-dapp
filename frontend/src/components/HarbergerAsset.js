      ...
      <div>
        ...
        <Container className="mt-5">
          ...
          <Row>
            <Col className="d-flex justify-content-center">
              <div className="text-center my-3">
                {!this.state.isLoadingToken && ((this.props.selectedAddress === this.props.creatorAddress && this.props.creatorBalance > 0) || (this.props.selectedAddress === this.props.adminAddress && this.props.adminBalance > 0)) ? (
          ...
          <Row>
            <Col className="d-flex justify-content-center">
              <div className="text-center my-3">
                {!this.state.isLoadingToken && this.props.selectedAddress === this.props.creatorAddress && this.props.timeExpired ? (
